...
export const fetchDataTQ= async (query:any ):Promise<Song[]>=>{
  ...
  const poslaneData = novePiesne.filter((piesen)=>
     Object.values(piesen).some(value =>
      typeof value === 'string' && value.toLowerCase().includes(queryna.toLowerCase())));
